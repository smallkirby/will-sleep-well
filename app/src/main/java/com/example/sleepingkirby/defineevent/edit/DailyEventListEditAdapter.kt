...
open class DailyEventListEditAdapter(val callback: (DailyEvent) -> Unit): ListAdapter<DailyEvent, DailyEventListEditAdapter.DailyEventViewHolder>(DailyEventComparator()) {
